...
export const LEGAL_CONTENT = {
    terms: `
        ...
        **2. Educational Purpose Only (Simulation)**<br/>
        TradeoBull is strictly a stock market simulator. All currency used on the platform is "virtual" or "paper money" and has no real-world monetary value. No actual securities, stocks, or financial instruments are bought, sold, or held on your behalf.<br/><br/>

        **3. No Financial Advice**<br/>
        Content, AI predictions, and market data provided on the Platform are for educational and entertainment purposes only. They do not constitute financial, investment, or legal advice. You should consult a certified financial advisor before making real-world investment decisions.<br/><br/>

        **4. Data Accuracy**<br/>
        While we strive to provide real-time market data via third-party APIs (e.g., Finnhub, Twelve Data), we cannot guarantee the accuracy, timeliness, or completeness of any data. Market feeds may be delayed or simulated. TradeoBull is not liable for any discrepancies.<br/><br/>
    ...
    `,
    privacy: `
        **Effective Date: October 26, 2023**<br/><br/>

        **1. Information We Collect**<br/>
        - **Personal Information:** We collect your Email Address and Name when you register to create a unique user profile and sync your progress.<br/>
        - **Usage Data:** We track your virtual trading history, portfolio holdings, and interaction with the app features to improve the simulation experience.<br/>
        - **Device Information:** We may collect information about the device and browser you use to access TradeoBull for optimization purposes.<br/><br/>
...
export const GUIDE_STEPS = [
  {
    ...
    content: "Imagine a giant supermarket, but instead of buying groceries, you are buying small pieces of companies. These pieces are called 'Shares' or 'Stocks'. When you buy a stock, you become a partial owner of that company. The NSE (National Stock Exchange) and BSE (Bombay Stock Exchange) are the markets where this buying and selling happens in India."
  },
  {
    title: "2. How do I make money?",
    content: "The goal is simple: Buy Low, Sell High. \n\n**Example:** You buy a stock of Reliance at ₹2400. If the price goes up to ₹2500, you make a profit of ₹100 per share. However, if the price drops to ₹2300, you lose ₹100. This is called 'Capital Appreciation'."
  },
  {
    title: "3. Market vs Limit Orders",
    content: "**Market Order:** You want to buy the stock IMMEDIATELY at whatever price is available right now. It guarantees execution but not the exact price.\n\n**Limit Order:** You set a specific price (e.g., Buy Reliance ONLY if it drops to ₹2350). The trade will only happen if the market hits your price."
  },
  {
    title: "4. Bull vs Bear Market",
    content: "**Bull Market (Green):** When the economy is doing well, prices are going up, and investors are optimistic.\n\n**Bear Market (Red):** When prices are falling, the economy is slowing down, and there is fear in the market."
  },
  {
    title: "5. Risk Management (Stop Loss)",
    content: "Never risk more than you can afford to lose. A 'Stop Loss' is a safety net. If you buy at ₹100, you might decide to sell automatically if it hits ₹95 to prevent further loss. In TradeoBull, practice cutting your losses early!"
  },
  {
    title: "6. Market Hours",
    content: "The Indian Stock Market is open from **9:15 AM to 3:30 PM**, Monday to Friday. You cannot trade on weekends or public holidays. In TradeoBull, the market is simulated 24/7 so you can practice anytime!"
  }
];
